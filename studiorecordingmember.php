...
<body>
	...
	<?
		...
		$cari="SELECT * FROM studio_recording where id_member_sr = ".$hasil['id'];
...
<table border="0">
	...
	<th align="left"><font face="cambria">Note</font></th>
		...
		<center><a href="formedit_sr.php?id=<?php echo $id; ?>"><img src="edit.png" width="40" height="40" title="Edit Profile"/></center>

...
<body>
    ...
    <div class="row-fluid">
		...
		<div class="span2">
			...
			<li class="active"><a href="sm_admin_utara.php"><font face="cambria">Surabaya Utara</font></a></li>
    ...
    <!--Body content-->
		...
		$cari="SELECT * FROM studio_musik where wilayah_sm like 'Utara'";

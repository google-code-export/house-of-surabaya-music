...
<body>
	...
	<li class="active"><a href="tokoalatmusikguest.php">Toko Alat Musik</a></li>
    ...
    <div class="row-fluid">
		...
		<div class="span2">
			...
			<li><a href="tokoalatmusikguest.php"><font face="cambria">Semua wilayah</font></a></li>
			<li><a href="tam_guest_utara.php"><font face="cambria">Surabaya Utara</font></a></li>
			<li><a href="tam_guest_barat.php"><font face="cambria">Surabaya Barat</font></a></li>
			<li class="active"><a href="tam_guest_selatan.php"><font face="cambria">Surabaya Selatan</font></a></li>
			<li><a href="tam_guest_timur.php"><font face="cambria">Surabaya Timur</font></a></li>
			</ul>
		</div>
    ...
    <!--Body content-->
		...
		$cari="SELECT * FROM toko_alat_musik where wilayah_tam like 'Selatan'";

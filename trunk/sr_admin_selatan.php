...
<body>
    ...
    <div class="row-fluid">
		...
		<div class="span2">
			...
			<li><a href="sr_admin_barat.php"><font face="cambria">Surabaya Barat</font></a></li>
			<li class="active"><a href="sr_admin_selatan.php"><font face="cambria">Surabaya Selatan</font></a></li>

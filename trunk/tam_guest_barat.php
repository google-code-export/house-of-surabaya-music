...
<body>
    ...
    <div class="row-fluid">
		...
		<div class="span2">
			...
			<li class="active"><a href="tam_guest_barat.php"><font face="cambria">Surabaya Barat</font></a></li>
			<li><a href="tam_guest_selatan.php"><font face="cambria">Surabaya Selatan</font></a></li>
    ...
    <!--Body content-->
		...
		$cari="SELECT * FROM toko_alat_musik where wilayah_tam like 'Barat'";

...
<body>
    ...
    <div class="row-fluid">
		...
		<div class="span2">
			...
			<li class="active"><a href="sm_admin_timur.php"><font face="cambria">Surabaya Timur</font></a></li>
			</ul>
		</div>
    ...
    <!--Body content-->
		...
		$cari="SELECT * FROM studio_musik where wilayah_sm like 'Timur'";

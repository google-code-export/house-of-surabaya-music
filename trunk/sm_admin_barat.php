...
<body>
	...
	<li class="active"><a href="studiomusik.php">Studio Musik</a></li>
    ...
    <div class="row-fluid">
		...
		<div class="span2">
			...
			<li><a href="studiomusik.php"><font face="cambria">Semua wilayah</font></a></li>
			<li><a href="sm_admin_utara.php"><font face="cambria">Surabaya Utara</font></a></li>
			<li class="active"><a href="sm_admin_barat.php"><font face="cambria">Surabaya Barat</font></a></li>
    ...
    <div class="span10">
    <!--Body content-->
				<form align="right" class="form-search pull-right" method="post" action="search_admin.php">
		...
		$cari="SELECT * FROM studio_musik where wilayah_sm like 'Barat'";
...
if(agree==true){
       window.location = 'delete_sm.php?id=' + id;
}
}
</script>
</body>

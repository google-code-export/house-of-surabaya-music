...
<body>
	...
	<a class="brand" href="home.php">HOS</a>
	<ul class="nav">
    ...
    <div class="row-fluid">
		...
		<div class="span2">
			...
			<li><a href="tokoalatmusik.php"><font face="cambria">Semua wilayah</font></a></li>
			...
			<li class="active"><a href="tam_admin_selatan.php"><font face="cambria">Surabaya Selatan</font></a></li>

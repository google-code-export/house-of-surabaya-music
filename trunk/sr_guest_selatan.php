...
<body>
	...
	<li class="active"><a href="studiorecordingguest.php">Studio Recording</a></li>
    ...
    <div class="row-fluid">
		<div class="span2">
			...
			<li><a href="studiorecordingguest.php"><font face="cambria">Semua wilayah</font></a></li>
			<li><a href="sr_guest_utara.php"><font face="cambria">Surabaya Utara</font></a></li>
			<li><a href="sr_guest_barat.php"><font face="cambria">Surabaya Barat</font></a></li>
			<li class="active"><a href="sr_guest_selatan.php"><font face="cambria">Surabaya Selatan</font></a></li>
			<li><a href="sr_guest_timur.php"><font face="cambria">Surabaya Timur</font></a></li>
			</ul>
		</div>		
	   ...
	   <div class="span10">
		...
		$cari="SELECT * FROM studio_recording where wilayah_sr like 'Selatan'";

...
<body>
	...
	<a class="brand">HOS</a>
	<ul class="nav">
	<li><a href="studiomusikmember.php?id=<?php echo $id; ?>">My Profile</a></li>
	<li class="active"><a href="postermember_sm.php?id=<?php echo $id; ?>">Event Musik Surabaya</a></li>
	...
	<form class="well span8" method="post" action="upload_postermembersm.php" enctype="multipart/form-data">

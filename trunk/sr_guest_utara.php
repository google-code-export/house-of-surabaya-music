...
<body>
    ...
    <div class="row-fluid">
		<div class="span2">
			...
			<li class="active"><a href="sr_guest_utara.php"><font face="cambria">Surabaya Utara</font></a></li>
			<li><a href="sr_guest_barat.php"><font face="cambria">Surabaya Barat</font></a></li>
			<li><a href="sr_guest_selatan.php"><font face="cambria">Surabaya Selatan</font></a></li>
	   ...
	   <div class="span10">
		...
		$cari="SELECT * FROM studio_recording where wilayah_sr like 'Utara'";

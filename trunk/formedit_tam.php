...
<body>
	...
	<a class="brand">HOS</a>
	<ul class="nav">
    <li class="active"><a href="tokoalatmusikmember.php?id=<?php echo $id; ?>">My Profile</a></li>
	<li><a href="postermember_tam.php?id=<?php echo $id; ?>">Event Musik Surabaya</a></li>
...
<form class="well span5" method="post" action="edit_tam.php?id=<?php echo $id; ?>">
		
		<label><b>Nama Toko Alat Musik</b></label>
		<input type="text" class="span5" placeholder="Type here..." name="nama" required="required"/><br/>
		
		<label><b>Alamat Toko Alat Musik</b></label>
		<input type="text" class="span5" placeholder="Type here..." name="alamat" required="required"/><br/>
		
		<label><b>Wilayah Toko Alat Musik</b></label>
		<label class="radio">
		...
		<textarea class="span5" rows="6" name="note"></textarea>

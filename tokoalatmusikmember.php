...
<body>
	...
	<?php
		...
		$cari="SELECT * FROM toko_alat_musik where id_member_tam = ".$hasil['id'];
		$hasil=mysql_query($cari) or die(mysql_error());
	...
	<th align="left"><font face="cambria">Note</font></th>
		...
		<center><a href="formedit_tam.php?id=<?php echo $id; ?>"><img src="edit.png" width="40" height="40" title="Edit Profile"/></center>
